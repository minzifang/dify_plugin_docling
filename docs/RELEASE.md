...
```bash
dify signature verify dist/docling-0.1.0.signed.difypkg \
  -p signing_keys/docling_plugin.public.pem
dify plugin checksum dist/docling-0.1.0.signed.difypkg
```
...
- `dist/docling-0.1.0.difypkg`
- `dist/docling-0.1.0.signed.difypkg`
